  ...
  return (
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <View style={styles.optionsContainer}>
          <TouchableOpacity style={{...styles.optionTouchable, backgroundColor:COLORS.danger}} onPress={() => navigation.navigate("NewLostPet")}>
          ...
          <TouchableOpacity style={{...styles.optionTouchable, backgroundColor:COLORS.success}} onPress={() => navigation.navigate("NewFoundPet")}>
          ...
          <TouchableOpacity style={{...styles.optionTouchable, backgroundColor:COLORS.light}} onPress={() => navigation.navigate("NewAdoptionPet")}>
