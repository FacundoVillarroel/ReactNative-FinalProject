import { View, Text, ScrollView, TouchableOpacity, Keyboard, Alert, ActivityIndicator } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        {/* Cuando */}
        <View style={styles.inputContainer}>
          <Text style={styles.inputTitle}>¿Cúando encontraste el animal?</Text>
          <Input 
            style={styles.input} 
        ...
        {/* Zona */}
        <View style={styles.inputContainer}>
          <Text style={styles.inputTitle}>¿En qué zona fue encontrado?</Text>
          {formState.lossZone.value.address && <Text style={styles.locationText}>{formState.lossZone.value.address}</Text>}
          <LocationSelector onLocationPicker={onHandleChangeInput} prevRoute="NewFoundPet"/>
        </View>
